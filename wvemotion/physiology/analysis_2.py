...
if __name__ == '__main__':
    LABELS_PATH = [
        './data/lab/label/071613.txt',
        './data/lab/label/071615.txt',
        './data/lab/label/071619.txt',
        './data/lab/label/071714.txt',
        './data/lab/label/071810.txt',
        './data/lab/label/071813.txt',
        './data/lab/label/071914.txt',
        './data/lab/label/071916.txt',
        './data/lab/label/072014.txt'
    ]
    EMOTION_KIND = ['angry', 'disgust', 'afraid', 'happy', 'sad', 'surprise']
    SIGNALS_PATH = [
        './data/lab/source/071613_潘亮晴.txt',
        './data/lab/source/071615_陳冠合.txt',
        './data/lab/source/071619_賴家正.txt',
        './data/lab/source/071714_曾弘軒.txt',
        './data/lab/source/071810_侯景勛.txt',
        './data/lab/source/071813_廖敏廷.txt',
        './data/lab/source/071914_張心瑜.txt',
        './data/lab/source/071916_陳亭妃.txt',
        './data/lab/source/072014_簡瑞梓.txt'
    ]
    VIDEO_NAME = [
        ['BASE', '22-A', '28-SA', '5-SU', '21-D', '35-H', '4-F'],
        ['BASE', '21-D', '5-SUA', '35-H', '22-A', '28-SA', '4-F'],
        ['BASE', '35-H', '22-A', '28-SA', '21-D', '5-SU', '4-F'],
        ['BASE', '28-SA', '21-D', '5-SU', '35-H', '4-F', '22-A'],
        ['BASE', '21-D', '35-H', '22-A', '5-SU', '28-SA', '4-F'],
        ['BASE', '4-F', '5-SU', '21-D', '28-SA', '22-A', '35-H'],
        ['BASE', '22-A', '5-SU', '4-F', '21-D', '35-H', '28-SA'],
        ['BASE', '4-F', '22-A', '21-D', '35-H', '5-SU', '28-SA'],
        ['BASE', '21-D', '4-F', '35-H', '28-SA', '22-A', '5-SU']
    ]
    TIME = [
        [(8, 0), (0, 0),
        (6, 39), (5, 20),
    ...
    data_dict_list = []
    for index in range(0, len(LABELS_PATH)):
        data_dict_list.append({'signal_path': SIGNALS_PATH[index], 'label_path': LABELS_PATH[index],
            'corresponding_time_list': TIME[index], 'video_name_list': VIDEO_NAME[index]})

    # Fragment need to consider lead time.
    EMOTION_FRAGMENT = [
        (((0, 0), (8, 0)), ((63, 31), (68, 59)), ((74, 14), (78, 53)), ((31, 22), (36, 20))),
        (((0, 0), (8, 0)), ((40, 9), (45, 37)), ((74, 14), (78, 53)), ((29, 56), (34, 53))),
        (((0, 0), (8, 0)), ((8, 1), (13, 29)), ((74, 15), (78, 53)), ((64, 1), (68, 59))),
        (((0, 0), (8, 0)), ((51, 50), (57, 18)), ((62, 38), (67, 17)), ((41, 32), (46, 30))),
        (((0, 0), (8, 0)), ((30, 2), (35, 30)), ((74, 40), (79, 18)), ((52, 53), (57, 52))),
        (((0, 0), (8, 0)), ((73, 50), (79, 15)), ((8, 1), (12, 39)), ((17, 59), (22, 57))),
        (((0, 0), (8, 0)), ((62, 21), (67, 50)), ((30, 23), (35, 1)), ((20, 4), (25, 3))),
        (((0, 0), (8, 0)), ((52, 3), (57, 31)), ((8, 1), (12, 39)), ((62, 51), (67, 49))),
        (((0, 0), (8, 0)), ((39, 59), (45, 27)), ((30, 1), (34, 39)), ((74, 19), (79, 18)))
    ]
    SPECIFIC_VIDEO_FRAGMENT = [
        (((63, 31), (68, 59)), (74, 14), (78, 53)),
        (((40, 9), (45, 37)), ((74, 14), (78, 53))),
        (((8, 1), (13, 29)), ((74, 15), (78, 53))),
        (((51, 50), (57, 18)), ((62, 38), (67, 17))),
        (((30, 2), (35, 30)), ((74, 40), (79, 18))),
        (((73, 50), (79, 15)), ((8, 1), (12, 39))),
        (((62, 21), (67, 50)), ((30, 23), (35, 1))),
        (((52, 3), (57, 31)), ((8, 1), (12, 39))),
        (((39, 59), (45, 27)), ((30, 1), (34, 39)))
    ]
    SPECIFIC_VIDEO_FRAGMENT_KIND_LIST = ['35(happy)', '4(afraid)']
    EMOTION_FRAGMENT_KIND_LIST = ['base', 'happy', 'afraid', 'surprise']
    HAPPY_FRAGMENT = [
        (
            ((63, 31), (64, 31)),
            ((64, 31), (65, 31)),
    ...
    SIGNAL_VIDEO_FRAGMENT_KIND_LIST = ['1min', '2min', '3min', '4min', 'END']
    ...
    ALL_DATA= data_dict_list
    INTERVAL_TIME = (5, 20)
    INTERVAL_SECOND = 0.001
    LEAD_TIME_NUMBER = 0
    SAVE_FOLDER_ROOT_PATH = './data/lab/chart_output/'
    # # emotion analysis fragment (per person per value kind per fragment) (check.)
    # for index in range(0, len(LABELS_PATH)):
    #     analyze_person_fragment(ALL_DATA[index]['signal_path'], EMOTION_FRAGMENT[index],
    #                         EMOTION_FRAGMENT_KIND_LIST, PEOPLE_NAME_LIST[index], 'emotion_fragment',
    #                         SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND)
    
    # x # video analysis fragment (per person per value kind per fragment) (check.)
    # for index in range(0, len(LABELS_PATH)):
    #     analyze_person_fragment(ALL_DATA[index]['signal_path'], SPECIFIC_VIDEO_FRAGMENT[index],
    #                             SPECIFIC_VIDEO_FRAGMENT_KIND_LIST, PEOPLE_NAME_LIST[index], 'video_fragment',
    #                             SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND)

    # x # video analysis fragment (per value kind per person per fragment)
    # all_video_analysis_dict_list = []
    # for index in range(0, len(all_video_analysis_dict_list)):
    #     all_video_analysis_dict_list.append({
    #     'signal_path': SIGNALS_PATH[index],
    #     'fragment_time_tuple': SPECIFIC_VIDEO_FRAGMENT[index]})
    # analyze_people_fragment(all_video_analysis_dict_list, PEOPLE_NAME_LIST,
    #                         SPECIFIC_VIDEO_FRAGMENT_KIND_LIST, 'video_fragment',
    #                         SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND)
    
    # x # HAPPY analysis fragment (per value kind per person per fragment) (check)
    # all_video_analysis_dict_list = []
    # for index in range(0, len(LABELS_PATH)):
    #     all_video_analysis_dict_list.append({
    #         'signal_path': SIGNALS_PATH[index],
    #         'fragment_time_tuple': HAPPY_FRAGMENT[index]})
    # analyze_people_fragment(all_video_analysis_dict_list, PEOPLE_NAME_LIST,
    #                         SIGNAL_VIDEO_FRAGMENT_KIND_LIST, 'HAPPY_fragment',
    #                         SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND)
    # # normalized ecg ver
    # analyze_people_fragment(all_video_analysis_dict_list, PEOPLE_NAME_LIST,
    #                         SIGNAL_VIDEO_FRAGMENT_KIND_LIST, 'HAPPY_fragment_normalized_ecg_ver',
    #                         SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND, ecg_normalize=True)
    # # AFRAID analysis fragment (per value kind per person per fragment)  (check)
    # all_video_analysis_dict_list = []
    # for index in range(0, len(LABELS_PATH)):
    #     all_video_analysis_dict_list.append({
    #         'signal_path': SIGNALS_PATH[index],
    #         'fragment_time_tuple': AFRAID_FRAGMENT[index]})
    # analyze_people_fragment(all_video_analysis_dict_list, PEOPLE_NAME_LIST,
    #                         SIGNAL_VIDEO_FRAGMENT_KIND_LIST, 'AFRAID_fragment',
    #                         SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND)
    # # normalize ver
    # analyze_people_fragment(all_video_analysis_dict_list, PEOPLE_NAME_LIST,
    #                         SIGNAL_VIDEO_FRAGMENT_KIND_LIST, 'AFRAID_fragment_normalized_ecg_ver',
    #                         SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND, ecg_normalize=True)

    # xx # GY analysis fragment (per value kind per person per fragment) (check)
    # PEYI_FRAGMENT_DATA = {
    ...
    # x # HAPPY sliding window analysis fragment (per value kind per person per fragment)  (check.)
    # all_video_analysis_dict_list = []
    # for index in range(0, len(LABELS_PATH)):
    #     all_video_analysis_dict_list.append({
    #         'signal_path': SIGNALS_PATH[index],
    #         'fragment_time_tuple': HAPPY_FRAGMENT_SLIDING})
    # analyze_people_fragment(all_video_analysis_dict_list, PEOPLE_NAME_LIST,
    #                         SIGNAL_VIDEO_FRAGMENT_SLIDING_KIND_LIST, 'HAPPY_sliding_fragment',
    #                         SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND)
    # # AFRAID analysis fragment (per value kind per person per fragment)  (check)
    # all_video_analysis_dict_list = []
    # for index in range(0, len(LABELS_PATH)):
    #     all_video_analysis_dict_list.append({
    #         'signal_path': SIGNALS_PATH[index],
    #         'fragment_time_tuple': AFRAID_FRAGMENT_SLIDING})
    # analyze_people_fragment(all_video_analysis_dict_list, PEOPLE_NAME_LIST,
    #                         SIGNAL_VIDEO_FRAGMENT_SLIDING_KIND_LIST, 'AFRAID_sliding_fragment',
    #                         SAVE_FOLDER_ROOT_PATH, INTERVAL_SECOND)
    pass
